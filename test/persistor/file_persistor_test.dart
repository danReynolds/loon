  ...
  group('hydrate', () {
    ...
    test(
      ...
      () async {
        ...
        //
        // Note that while the `friends` data store contains the data for both the `friends` collection
        // as well a the `users__1__friends` data, only the data in the store under the `users` path should
